...
| **MaxUIKit** | Корпоративная UI-библиотека от Mail.ru Group |
...
Этот проект разработан в рамках участия в конкурсе и использует корпоративные технологии Mail.ru Group.
